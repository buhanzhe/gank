...
import com.buhanzhe.gank.adapter.PhotoAdapter;
import com.buhanzhe.gank.listener.PermissionListener;
...
public class PhotoActivity extends BaseSkinActivity{
    ...
    private void initView() {
        ...
        photoShare.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View view) {
                BaseSkinActivity.requestRunTimePermissions(BaseSkinActivity.COMMON_PERMISSIONS, new PermissionListener() {
                    @Override
